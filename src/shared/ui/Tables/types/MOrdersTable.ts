...
import { DataTypeOrder } from "../../../api/store/models/MOrganizationSlice"
...
export interface IOrdersTable {
    dataOrders: DataTypeTableOrder[]
    setDataOrders: React.Dispatch<React.SetStateAction<DataTypeTableOrder[]>>
}